  ...
  return <main className="luna-shell">
    <header className="topbar">
      ...
      <div className="top-actions">
        <div className="market-status"><CircleDot size={11}/> SET / {session?.mode?.toUpperCase()??"PAPER"}</div>
    ...
    <div className="page">
      <section className="hero-row"><div><div className="eyebrow">INTRADAY CONTROL · LIVE PORTFOLIO</div><h2>What LUNA owns right now</h2><p>Database-backed holdings, executions, P&amp;L and risk exposure.</p></div><div className="safe-badge"><ShieldCheck size={15}/> {session?.mode?.toUpperCase()??"PAPER"} / SAFE</div></section>
