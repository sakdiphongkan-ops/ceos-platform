...
assert extract_broker_native_submitted_at_ms({"data":{"created_at":"2026-09-22T13:00:00Z"}})==1790082000000
assert extract_broker_native_submitted_at_ms({"data":{"foo":"bar"}}) is None
